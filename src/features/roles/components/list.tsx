  ...
  return (
    <div className="flex flex-row justify-between">
      <div className="flex flex-row gap-2">
        <Input placeholder="Search roles..." className="w-md" />
...
export default function RoleList({ columns }: RoleListProp) {
  ...
  const pageData = (roles ?? []).slice((page - 1) * pageSize, page * pageSize);
