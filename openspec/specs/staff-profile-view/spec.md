# staff-profile-view Specification

## Purpose

Lets any authenticated user (Staff, Manager, or Admin) view and self-manage their own account
from a dedicated "Cá nhân" section: personal info and branch assignment(s), self-editable contact
details, voluntary password change, and logout.
